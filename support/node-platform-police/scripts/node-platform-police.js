...
if (!fileExists('node-platform-police.ignore')) {
  ...
  var commandOutput = execCommandWithOutput('npm outdated --registry=http://repo.dev.wixpress.com/artifactory/api/npm/npm-repos --json --long');
  var output = commandOutput.length === 0 ? {} : JSON.parse(commandOutput);
