...
var requestIdGenerator = require('../lib/rpcRequestIdGenerator');
var serializer = require('../lib/rpcProtocolSerializer')(requestIdGenerator);
...
describe("signer", function(){      
  ...
  var jsonRequestForLength = function(length){
    return serializer.serialize('method', [chance.string({length: length})]);
  };
