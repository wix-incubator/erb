...
describe('require login | run modes', () => {
    ...
    describe(environment, function () {
      ...
      describe('redirect', () => {
        ...
        it('Redirects to a URL with return params when not authenticated', () => {
          ...
          const redirectUrl = `${redirectBaseUrl}?originUrl=${encodedReturnUrl}&redirectTo=${encodedReturnUrl}&overrideLocale=en`;
