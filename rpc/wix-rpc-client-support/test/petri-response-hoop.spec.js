...
describe('petri response hook', () => {
  it('should not rewrite because there is no petri response cookies', () =>{
    const ctx = new PetriContext({});
    petriResponseHook.get(ctx)({});
    expect(ctx.get()).to.deep.equal({});
  });
